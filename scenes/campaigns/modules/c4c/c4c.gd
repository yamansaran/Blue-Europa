extends RefCounted
class_name CampaignModuleC4C
## ============================================================================
## CAMPAIGN "c4c"  —  Longyearbyen   (level 4, path C)
## ============================================================================
...
const ID           := "c4c"
const DISPLAY_NAME := "Longyearbyen"
const OVERWORLD    := "res://scenes/campaigns/modules/c4c/overworld_c4c.tscn"
const MAP_POSITION := Vector2(0.3875, 0.82)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "tundra", "level": 4, "path": "c"}
	return c
