extends RefCounted
class_name CampaignModuleC8A
## ============================================================================
## CAMPAIGN "c8a"  —  Vienna   (level 8, path A)
## ============================================================================
...
const ID           := "c8a"
const DISPLAY_NAME := "Vienna"
const OVERWORLD    := "res://scenes/campaigns/modules/c8a/overworld_c8a.tscn"
const MAP_POSITION := Vector2(0.8375, 0.18)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "lowland", "level": 8, "path": "a"}
	return c
