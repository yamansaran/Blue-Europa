extends RefCounted
class_name CampaignModuleC6C
## ============================================================================
## CAMPAIGN "c6c"  —  Nenetsia   (level 6, path C)
## ============================================================================
...
const ID           := "c6c"
const DISPLAY_NAME := "Nenetsia"
const OVERWORLD    := "res://scenes/campaigns/modules/c6c/overworld_c6c.tscn"
const MAP_POSITION := Vector2(0.6125, 0.82)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "coast", "level": 6, "path": "c"}
	return c
