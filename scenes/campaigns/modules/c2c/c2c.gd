extends RefCounted
class_name CampaignModuleC2C
## ============================================================================
## CAMPAIGN "c2c"  —  Oscarhavn   (level 2, path C)
## ============================================================================
...
const ID           := "c2c"
const DISPLAY_NAME := "Oscarhavn"
const OVERWORLD    := "res://scenes/campaigns/modules/c2c/overworld_c2c.tscn"
const MAP_POSITION := Vector2(0.1625, 0.82)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "glacier", "level": 2, "path": "c"}
	return c
