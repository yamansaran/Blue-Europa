extends RefCounted
class_name CampaignModuleC5C
## ============================================================================
## CAMPAIGN "c5c"  —  Mezhdusharsky   (level 5, path C)
## ============================================================================
...
const ID           := "c5c"
const DISPLAY_NAME := "Mezhdusharsky"
const OVERWORLD    := "res://scenes/campaigns/modules/c5c/overworld_c5c.tscn"
const MAP_POSITION := Vector2(0.5000, 0.82)
const BG_COLOR     := Color(0.16, 0.41, 0.78)
## LEVEL 5 is the map's one mid-run choice: Mezhdusharsky opens onto Nenetsia or Boston.
const NEXT_IDS     := ["c6c", "c6a"]
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "tundra", "level": 5, "path": "c"}
	return c
