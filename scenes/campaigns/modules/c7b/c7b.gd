extends RefCounted
class_name CampaignModuleC7B
## ============================================================================
## CAMPAIGN "c7b"  —  Copenhagen   (level 7, path B)
## ============================================================================
...
const ID           := "c7b"
const DISPLAY_NAME := "Copenhagen"
const OVERWORLD    := "res://scenes/campaigns/modules/c7b/overworld_c7b.tscn"
const MAP_POSITION := Vector2(0.7250, 0.50)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "lowland", "level": 7, "path": "b"}
	return c
