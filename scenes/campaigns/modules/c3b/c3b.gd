...
## ============================================================================
## CAMPAIGN "c3b"  —  Bluie West Seven   (level 3, path B)
## ============================================================================
...
const ID           := "c3b"
const DISPLAY_NAME := "Bluie West Seven"
const OVERWORLD    := "res://scenes/campaigns/modules/c3b/overworld_c3b.tscn"
const MAP_POSITION := Vector2(0.2750, 0.50)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "ice_shelf", "level": 3, "path": "b"}
	return c
