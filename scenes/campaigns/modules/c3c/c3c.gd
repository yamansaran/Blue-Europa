extends RefCounted
class_name CampaignModuleC3C
## ============================================================================
## CAMPAIGN "c3c"  —  Myggbukta   (level 3, path C)
## ============================================================================
...
const ID           := "c3c"
const DISPLAY_NAME := "Myggbukta"
const OVERWORLD    := "res://scenes/campaigns/modules/c3c/overworld_c3c.tscn"
const MAP_POSITION := Vector2(0.2750, 0.82)
const BG_COLOR     := Color(0.12, 0.49, 0.80)
...
const SHOP_STOCK   := ["iron_sword", "leather_vest", "leather_cap", "minor_potion"]
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "ice_shelf", "level": 3, "path": "c"}
	return c
