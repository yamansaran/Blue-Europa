...
## ============================================================================
## CAMPAIGN "c3a"  —  Resolution Island   (level 3, path A)
## ============================================================================
...
const ID           := "c3a"
const DISPLAY_NAME := "Resolution Island"
const OVERWORLD    := "res://scenes/campaigns/modules/c3a/overworld_c3a.tscn"
const MAP_POSITION := Vector2(0.2750, 0.18)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "ice_shelf", "level": 3, "path": "a"}
	return c
