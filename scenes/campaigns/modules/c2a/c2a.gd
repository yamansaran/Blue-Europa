...
## ============================================================================
## CAMPAIGN "c2a"  —  Godhavn   (level 2, path A)
## ============================================================================
...
const ID           := "c2a"
const DISPLAY_NAME := "Godhavn"
const OVERWORLD    := "res://scenes/campaigns/modules/c2a/overworld_c2a.tscn"
const MAP_POSITION := Vector2(0.1625, 0.18)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "glacier", "level": 2, "path": "a"}
	return c
