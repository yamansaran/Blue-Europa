extends RefCounted
class_name CampaignModuleC8C
## ============================================================================
## CAMPAIGN "c8c"  —  Warsaw   (level 8, path C)
## ============================================================================
...
const ID           := "c8c"
const DISPLAY_NAME := "Warsaw"
const OVERWORLD    := "res://scenes/campaigns/modules/c8c/overworld_c8c.tscn"
const MAP_POSITION := Vector2(0.8375, 0.82)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "lowland", "level": 8, "path": "c"}
	return c
