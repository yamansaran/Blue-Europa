extends RefCounted
class_name CampaignModuleC5B
## ============================================================================
## CAMPAIGN "c5b"  —  Rorvik   (level 5, path B)
## ============================================================================
...
const ID           := "c5b"
const DISPLAY_NAME := "Rorvik"
const OVERWORLD    := "res://scenes/campaigns/modules/c5b/overworld_c5b.tscn"
const MAP_POSITION := Vector2(0.5000, 0.50)
const BG_COLOR     := Color(0.16, 0.41, 0.78)
## LEVEL 5 is the map's one mid-run choice: Rorvik opens onto Oslo or Nenetsia.
const NEXT_IDS     := ["c6b", "c6c"]
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "tundra", "level": 5, "path": "b"}
	return c
