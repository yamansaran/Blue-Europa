extends RefCounted
class_name CampaignModuleC4B
## ============================================================================
## CAMPAIGN "c4b"  —  Reykjavik   (level 4, path B)
## ============================================================================
...
const ID           := "c4b"
const DISPLAY_NAME := "Reykjavik"
const OVERWORLD    := "res://scenes/campaigns/modules/c4b/overworld_c4b.tscn"
const MAP_POSITION := Vector2(0.3875, 0.50)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "tundra", "level": 4, "path": "b"}
	return c
