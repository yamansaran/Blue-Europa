extends RefCounted
class_name CampaignModuleC6A
## ============================================================================
## CAMPAIGN "c6a"  —  Boston   (level 6, path A)
## ============================================================================
...
const ID           := "c6a"
const DISPLAY_NAME := "Boston"
const OVERWORLD    := "res://scenes/campaigns/modules/c6a/overworld_c6a.tscn"
const MAP_POSITION := Vector2(0.6125, 0.18)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "coast", "level": 6, "path": "a"}
	return c
