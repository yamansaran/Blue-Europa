extends RefCounted
class_name CampaignModuleC7A
## ============================================================================
## CAMPAIGN "c7a"  —  Naples   (level 7, path A)
## ============================================================================
...
const ID           := "c7a"
const DISPLAY_NAME := "Naples"
const OVERWORLD    := "res://scenes/campaigns/modules/c7a/overworld_c7a.tscn"
const MAP_POSITION := Vector2(0.7250, 0.18)
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "lowland", "level": 7, "path": "a"}
	return c
