extends RefCounted
class_name CampaignModuleC4A
## ============================================================================
## CAMPAIGN "c4a"  —  Chesterfield Inlet   (level 4, path A)
## ============================================================================
...
const ID           := "c4a"
const DISPLAY_NAME := "Chesterfield Inlet"
const OVERWORLD    := "res://scenes/campaigns/modules/c4a/overworld_c4a.tscn"
const MAP_POSITION := Vector2(0.3875, 0.18)
const BG_COLOR     := Color(0.14, 0.45, 0.80)
...
const SHOP_STOCK   := ["oak_shield", "iron_gauntlets", "swift_boots", "minor_potion"]
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "tundra", "level": 4, "path": "a"}
	return c
