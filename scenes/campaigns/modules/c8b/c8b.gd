extends RefCounted
class_name CampaignModuleC8B
## ============================================================================
## CAMPAIGN "c8b"  —  Hanover   (level 8, path B)
## ============================================================================
...
const ID           := "c8b"
const DISPLAY_NAME := "Hanover"
const OVERWORLD    := "res://scenes/campaigns/modules/c8b/overworld_c8b.tscn"
const MAP_POSITION := Vector2(0.8375, 0.50)
const BG_COLOR     := Color(0.22, 0.26, 0.60)
...
const SHOP_STOCK   := ["lucky_charm", "ember_ring", "leather_cap", "minor_potion"]
...
static func build() -> Campaign:
	...
	c.extra         = {"biome": "lowland", "level": 8, "path": "b"}
	return c
